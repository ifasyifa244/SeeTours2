	...
	<div class="jumbotron">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form action="{{route('rumahmakan.store')}}" method="post" enctype="multipart/form-data">
					{{csrf_field()}}
					...
					<div class="form-group">
						...
						<input type="text" name="name" class="form-control" placeholder="Nama Rumah Makan">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-lable">Image Rumah Makan</label>
