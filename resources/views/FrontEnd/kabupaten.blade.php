...
<body class="home">
	...
	<header id="head">
		<div class="container">
			<div class="row">
				@php
				$kat = App\Kategori::find()
				@endphp
				<h1 class="lead"><marquee>OBJEK WISATA KABUPATEN BANDUNG</marquee></h1>
				<p class="tagline"><a href="http://www.gettemplate.com/?utm_source=progressus&amp;utm_medium=template&amp;utm_campaign=progressus">Find Your Destination Here!</a></p>
			</div>
		</div>
	</header>
	<!-- /Header -->
	...
	<div class="container">
		...
		<div class="jumbotron top-space">
     		...
     		<p class="text-right"><a href="{{url('/detail',$data->id)}}" class="btn btn-primary btn-large btn-block">See more »</a></p>
  		</div>
  		</div>
  		@endforeach
</div>	<!-- /container -->
