...
<body class="home">
	...
	<header id="head">
		<div class="container">
			<div class="row">
				<h1 class="lead">OBJEK WISATA {{$kategori->nama_kategori}} BANDUNG</h1>
				<h3><p class="tagline"><a href="http://www.gettemplate.com/?utm_source=progressus&amp;utm_medium=template&amp;utm_campaign=progressus">Find Your Destination Here!</a></p></h3>
			</div>
		</div>
	</header>
	<!-- /Header -->
	...
	<div class="container">
		...
		<div class="jumbotron top-space">
     		...
     		<p class="text-right"><a href="{{url('/detail',$data->slug)}}" class="btn btn-primary btn-large btn-block">See more »</a></p>
  		</div>
  		</div>
  		@endforeach
</div>	<!-- /container -->
