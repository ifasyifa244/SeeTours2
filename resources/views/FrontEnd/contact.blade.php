...
<head>
	...
	<title>Contact us - SeeTours</title>
		...
		<div class="row">
				...
				<br>
					<form action="{{url('/kirim')}}" method="post">
						...
						<div class="row">
							...
							<div class="col-sm-4">
								<input class="form-control" type="text" name="no_telp" placeholder="No.Telpon">
							</div>
						</div>
						<br>
						<div class="row">
							<div class="col-sm-12">
								<textarea placeholder="Tulis Pesan Disini..."   name="pesan" class="form-control" rows="9"></textarea>
							</div>
						</div>
						<br>
						<div class="row">
			...
			<aside class="col-sm-3 sidebar sidebar-right">
				...
				<div class="widget">
					<h4>Address</h4>
					<address>
						SMK Assalaam Bandung Jl. Situtarate, Terusan Cibaduyut Kab. Bandung
					</address>
					<h4>Phone:</h4>
					<address>
						(713) 791-1414
