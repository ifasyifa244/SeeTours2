...
<body>
	...
	<div class="container">
		...
		<p><font face=" Trebuchet MS" size="3"> Alamat : </font><font face="Trebuchet MS" size="3">{{$data->alamat}}</font></p>
		<p><font face="Trebuchet MS" size="3"> Jadwal :</font><font face="Trebuchet MS" size="3"> {{$data->jadwal}}</font></p>
		<p><font face="Trebuchet MS" size="3"> No. Telpon :</font><font face="Trebuchet MS" size="3"> {{$data->no_telp}}</font></p>
